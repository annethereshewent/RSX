...
impl CPU {
  pub fn new(bios: Vec<u8>, game_file: Option<File>, game_bytes: Option<Vec<u8>>, is_wasm: bool) -> Self {
    ...
    Self {
      ...
      hi: 0,
      low: 0,
      bus: Bus::new(bios, interrupts.clone(), dma.clone(), game_file, game_bytes, is_wasm),
      load: None,
      branch: false,
      delay_slot: false,
      cop0: COP0 {

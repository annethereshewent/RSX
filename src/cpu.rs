use std::{cell::Cell, collections::{HashSet, VecDeque}, fs::{self, File}, rc::Rc, sync::{Arc, Mutex}};
...
impl CPU {
    ...
    audio_samples: Arc<Mutex<VecDeque<i16>>>) -> Self
  {
    ...
    Self {
      ...
      hi: 0,
      low: 0,
      bus: Bus::new(bios, interrupts.clone(), dma.clone(), game_file, game_bytes, is_wasm, audio_samples),
      load: None,
      branch: false,
      delay_slot: false,
      cop0: COP0 {

...
impl Bus {
  pub fn new(bios: Vec<u8>, interrupts: Rc<Cell<InterruptRegisters>>, dma: Rc<Cell<DMA>>, game_file: &String, is_wasm: bool) -> Self {
    Self {
      bios,
      ...
      cdrom: Cdrom::new(interrupts.clone(), game_file, is_wasm),
